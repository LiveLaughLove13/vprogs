...
|-------|--------|---------|
| 0 | [core/](core/) | Foundational types, atomics, macros |
| 1 | [storage/](storage/) | Persistence layer: how we access the disk |
| 2 | [state/](state/) | State semantics: what we store |
| 3 | [scheduling/](scheduling/) | Execution orchestration: how we access the CPU |
| 4 | [transaction-runtime/](transaction-runtime/) | Execution semantics |
| 5 | [node/](node/) | VM implementation |
...
For Cairo privacy flows, wallet integration status, and example commands, see:

- [CAIRO_PRIVACY_WALLET_INTEGRATION.md](CAIRO_PRIVACY_WALLET_INTEGRATION.md)
- [node/transaction-submitter/EXAMPLES_GUIDE.md](node/transaction-submitter/EXAMPLES_GUIDE.md)
